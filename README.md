...
reactscript-cli/1.0.1 linux-x64 node-v10.15.2
...
_See code: [src/commands/create.ts](https://github.com/paranoiasystem/reactscript-cli/blob/v1.0.1/src/commands/create.ts)_
